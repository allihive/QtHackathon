...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.buttonSun.setOnClickListener {
            sun++
            binding.buttonSun.setBackgroundColor(resources.getColor(R.color.sun, null)) // reset color
            checkKuku()
        }

        binding.buttonRain.setOnClickListener {
            rain++
            binding.buttonRain.setBackgroundColor(resources.getColor(R.color.rain, null)) // reset color
            checkKuku()
        }
